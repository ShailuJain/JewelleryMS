...
//                        $rs=$model_name::select();
                    while($row = $rs->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<td><a class='btn btn-secondary text-white' data-toggle='tooltip' href='udhaari.php?src=add-udhaari&p-of=udhaari&id={$row['udhaari_id']}' data-html='true' title='Make udhaari'><i class='fa fa-money-bill-wave'></i></a></td>";
                        echo "<td><a class='btn btn-danger text-white delete' data-toggle='modal' data-target='#deleteModal' data-html='true' title='Delete this udhaari' data-delete='udhaari.php?form=delete-udhaari&id={$row["udhaari_id"]}'><i class='fa fa-trash'></i></a></td>";
                        echo "</tr>";
                    }
                    ?>
                    </tbody>
