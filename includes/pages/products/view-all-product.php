        ...
        <div class="table-responsive">
            <table id="tables" class="table table-bordered">
                ...
                while($row = $rs->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td><a class='btn btn-danger text-white delete' data-toggle='modal' data-target='#deleteModal' data-html='true' title='Delete this product' data-delete='process-form.php?form=products/delete&id={$row["product_id"]}'><i class='fa fa-times'></i></a></td>";
                    echo "</tr>";
                }
                ?>
                </tbody>
