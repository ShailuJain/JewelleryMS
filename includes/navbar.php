    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php include_once("db/models/User.class.php");
                    if (isset($_SESSION['user_id'])) {
                        $rs = User::select("username", 0, "user_id=?", $_SESSION['user_id']);
                        $details = $rs->fetch();
                    ...
                    echo $user_name;
                    ?></span>
                <div id="h-profile" class="img-profile rounded-circle" style="background-color: #777777;"></div>
            </a>
